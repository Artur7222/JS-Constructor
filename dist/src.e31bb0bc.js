...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/js1.png":[function(require,module,exports) {
module.exports = "/js1.e15f27bc.png";
...
var _js = _interopRequireDefault(require("./assets/js1.png"));

var _blocks = require("./classes/blocks");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var text = "Какой ни будь умный текст, что бы красиво было";
var model = [new _blocks.TitleBlock('Конструктор сайтов на JavaScript', {
...
}), new _blocks.ImageBlock(_js.default, {
  styles: {
    padding: '2rem 0',
    display: 'flex',
  ...
  alt: 'Это картинка'
}), new _blocks.ColumnsBlock(['Мое первое приложение на чистом JavaScript', 'Хороший, интересный курс настолько без воды, что ничего не понятно, но я стараюсь', 'JavaScript - это очень просто. Шучу. Это вообще не просто, пойду выпью чего ни будь'], {
  styles: {
...
exports.model = model;
},{"./assets/js1.png":"assets/js1.png","./classes/blocks":"classes/blocks.js"}],"classes/site.js":[function(require,module,exports) {
"use strict";
